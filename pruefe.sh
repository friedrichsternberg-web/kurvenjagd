...
APP="app.js garage.js finder.js freisteller.js konto.js touren.js shop.js kern.js produkte.js besucher.js index.html"
JS="app.js garage.js finder.js freisteller.js konto.js touren.js shop.js kern.js geraet.js produkte.js besucher.js"
